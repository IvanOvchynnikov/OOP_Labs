...
/**
 * Це клас Main, в якому відбувається взаємодія з корстувачем та прописаний процес гри.
 * @author Овчинніков Іван
 */

public class Main {
    /**
     *
     * Функція main , в якій відбувається вся взаємодія
     * @param args - Це аргументи з командної строки
     */
    public static void main(String[] args) {
        ...
        while(chips>0){
            ...
            table_num--;
            while(chips>0 && chips>=casino.tables[table_num].minBid){
                ...
                if(chips<casino.tables[table_num].minBid && chips!=0) System.out.println("You need to change a table, you don't have enough money for this one:");
            }
        }
